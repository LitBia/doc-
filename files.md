...
* litbia.conf: contains configuration settings for litbiad or litbia-qt
* litbiad.pid: stores the process id of litbiad while running
...
* debug.log: contains debug information and general logging generated by litbiad or litbia-qt
